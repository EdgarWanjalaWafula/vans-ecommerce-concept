                ...
                <div className="row align-items-center justify-content-between">
                    ...
                    <div className="col-md-3">
                        <ul className="d-flex justify-content-between shop-filters">
                            ...
                            <li className="d-flex align-items-center"><h6 className="m-0">Filter</h6><i className="bi bi-sliders"></i></li>
                            <li className="d-flex align-items-center"><h6 className="m-0">Sort</h6><i className="bi bi-chevron-down"></i></li>
                        </ul>
                    </div>
                </div>
